...
def parse_args():
    ...
    parser.add_argument('--meth', dest='meth', help='training method, alt_opt[default] or end2end',
                        default=0, type=int)
...
if __name__ == '__main__':
    ...
    METH = 'faster_rcnn_alt_opt' if args.meth == 0 else 'faster_rcnn_end2end'

    prototxt = os.path.join(cfg.MODELS_DIR, NETS[args.demo_net][0],
                            METH, 'faster_rcnn_test.pt')
    caffemodel = os.path.join('output', METH, 'wider',
